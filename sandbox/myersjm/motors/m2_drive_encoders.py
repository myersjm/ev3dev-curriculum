...
def main():
    ...
    while time_s != 0:
        ...
        if distance != 0 and left_sp != 0:
            left_motor.run_to_rel_pos(speed_sp=left_sp, position_sp=position, stop_action=ev3.Motor.STOP_ACTION_BRAKE)
            right_motor.run_to_rel_pos(speed_sp=left_sp, position_sp=position, stop_action=ev3.Motor.STOP_ACTION_BRAKE)
