...
def main():
    ...
    while True:
        turn_speed_sp = int(input("Enter turning speed (0 to 900 dps): "))
        if turn_speed_sp == 0:
            break
        degrees_to_turn = int(input("How many degrees would you like to turn?"))
        if degrees_to_turn == 0:
            break

        ev3.turn_degrees(degrees_to_turn, turn_speed_sp)
