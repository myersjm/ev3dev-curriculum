...
def main():
    ...
    my_name = "Jessica"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Casey"  # Used to set the topic that you will *publish to*

    # What happens if you set my_name and team_member_name to the same value? says it twice
