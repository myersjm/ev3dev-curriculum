...
def seek_beacon(robot):
    ...
    while not robot.touch_sensor.is_pressed:
        ...
        current_heading = beacon_seeker.heading #0 # use the beacon_seeker heading
        current_distance = beacon_seeker.distance #0  # use the beacon_seeker distance
